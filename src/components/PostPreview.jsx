    ...
    render : function() {
        return (
            <a href="#" className="single-post" onClick={this.loadPost}>
                ...
                <div className="author-details"><img src={this.props.post.author.photo} className="author-photo"/><span className="author-name">{this.props.post.author.date}</span></div>
            </a>
        )
    }
});
